...
===START_SCRIPT===
[Write ALL segment scripts here - one after another, numbered clearly]
===END_SCRIPT===

CRITICAL INSTRUCTIONS:
- Output ONLY the script content between ===START_SCRIPT=== and ===END_SCRIPT===
- DO NOT add any other text, suggestions, or recommendations after ===END_SCRIPT===
- DO NOT suggest follow-up actions or ask if I want more variations
- The output between the markers is the COMPLETE required response`;
};

...
const STYLE_CATEGORIES = {
  ...
  expression: {
    ...
    options: [
      ...
      { value: 'serious-focus', label: 'Serious Focus' },
  ...
  gesture: {
    ...
    options: [
      ...
      { value: 'holding-near-face', label: 'Holding Near Face' },
      { value: 'reaction-hands', label: 'Reaction Hands' },
      { value: 'thumbs-up', label: 'Thumbs Up' },
      { value: 'crossed-arms', label: 'Crossed Arms' },
      { value: 'not-needed', label: 'No Specific Gesture' },
    ],
  },
  textOverlayZone: {
  ...
  productPresence: {
    ...
    options: [
      ...
      { value: 'not-needed', label: 'No Product Needed' },
    ],
  },
  storyRole: {
    label: 'Story Role',
    ...
    options: [
      ...
      { value: 'mysterious-lead', label: 'Mysterious Lead' },
    ],
  },
  pose: {
    label: 'Story Pose',
    ...
    options: [
      ...
      { value: 'explaining', label: 'Explaining / Host Pose' },
      { value: 'listening', label: 'Listening' },
      { value: 'dramatic-turn', label: 'Dramatic Turn' },
      { value: 'confident-hero-pose', label: 'Confident Hero Pose' },
      { value: 'seated-storyteller', label: 'Seated Storyteller' },
    ],
  },
  sceneDepth: {
    label: 'Scene Depth',
    ...
    options: [
      ...
      { value: 'cinematic-depth', label: 'Cinematic Depth' },
      { value: 'layered-world', label: 'Layered World' },
    ],
  },
  propCue: {
    label: 'Prop Cue',
    ...
    options: [
      ...
      { value: 'mystery-item', label: 'Mystery Item' },
      { value: 'brand-prop', label: 'Brand Prop' },
      { value: 'not-needed', label: 'No Prop Needed' },
    ],
  },
  shotType: {
    label: 'Loáº¡i chá»¥p',

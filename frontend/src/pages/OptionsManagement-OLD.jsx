...
function SceneDetailEditor({ scene, onRefresh }) {
  ...
  return (
    <div className="studio-card-shell flex flex-col gap-4 rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/40 via-slate-800/20 to-slate-900/40 p-5 shadow-xl overflow-hidden">
      {/* Header Section */}
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-50">
      <div className="mx-auto max-w-7xl px-5 py-6 lg:px-6">
        ...
        <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
          <div>
            <h1 className="mb-1 flex items-center gap-3 text-3xl font-bold text-white">
          ...
          <button 
            onClick={loadScenes}
            disabled={refreshing}
            className="inline-flex items-center gap-2 rounded-lg border border-indigo-500/25 bg-indigo-500/10 px-3 py-2 text-sm font-medium text-indigo-200 transition hover:bg-indigo-500/15 disabled:opacity-50"
          >
        ...
        <div className="flex gap-4">
          ...
          <div className="w-80 flex-shrink-0">
            <div className="studio-accent-panel rounded-2xl border border-white/10 px-3 py-3 shadow-lg max-h-[calc(100vh-280px)] overflow-y-auto">
